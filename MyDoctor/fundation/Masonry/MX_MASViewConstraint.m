...
@interface MX_MASViewConstraint ()

@property (nonatomic, strong, readwrite) MX_MASViewAttribute *secondViewAttribute;
@property (nonatomic, weak) MAS_VIEW *installedView;
@property (nonatomic, weak) MX_MASLayoutConstraint *layoutConstraint;
@property (nonatomic, assign) NSLayoutRelation layoutRelation;
@property (nonatomic, assign) MX_MASLayoutPriority layoutPriority;
...
@implementation MX_MASViewConstraint
...
- (id)copyWithZone:(NSZone __unused *)zone {
    MX_MASViewConstraint *constraint = [[MX_MASViewConstraint alloc] initWithFirstViewAttribute:self.firstViewAttribute];
...
- (void)setSecondViewAttribute:(id)secondViewAttribute {
    if ([secondViewAttribute isKindOfClass:NSValue.class]) {
        ...
        _secondViewAttribute = [[MX_MASViewAttribute alloc] initWithView:secondViewAttribute layoutAttribute:self.firstViewAttribute.layoutAttribute];
    } else if ([secondViewAttribute isKindOfClass:MX_MASViewAttribute.class]) {
    ...
    return ^id(id attribute, NSLayoutRelation relation) {
        if ([attribute isKindOfClass:NSArray.class]) {
            ...
            for (id attr in attribute) {
                MX_MASViewConstraint *viewConstraint = [self copy];
...
- (void)install {
    ...
    MX_MASLayoutConstraint *layoutConstraint
        = [MX_MASLayoutConstraint constraintWithItem:firstLayoutItem
    ...
    MX_MASLayoutConstraint *existingConstraint = nil;
...
- (MX_MASLayoutConstraint *)layoutConstraintSimilarTo:(MX_MASLayoutConstraint *)layoutConstraint {
    // check if any constraints are the same apart from the only mutable property constant

    // go through constraints in reverse as we do not want to match auto-resizing or interface builder constraints
    // and they are likely to be added first.
    for (NSLayoutConstraint *existingConstraint in self.installedView.constraints.reverseObjectEnumerator) {
        if (![existingConstraint isKindOfClass:MX_MASLayoutConstraint.class]) continue;
