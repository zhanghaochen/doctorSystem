...
#import <Foundation/Foundation.h>
    ...
    typedef UILayoutPriority MX_MASLayoutPriority;
    static const MX_MASLayoutPriority MASLayoutPriorityRequired = UILayoutPriorityRequired;
    static const MX_MASLayoutPriority MASLayoutPriorityDefaultHigh = UILayoutPriorityDefaultHigh;
    static const MX_MASLayoutPriority MASLayoutPriorityDefaultMedium = 500;
    static const MX_MASLayoutPriority MASLayoutPriorityDefaultLow = UILayoutPriorityDefaultLow;
    static const MX_MASLayoutPriority MASLayoutPriorityFittingSizeLevel = UILayoutPriorityFittingSizeLevel;
